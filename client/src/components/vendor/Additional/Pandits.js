    ...
    onChange = async (event) => {
      ...
      onUpload1 = async (e) => {
        ...
        this.setState({ img1:"https://res.cloudinary.com/dzcmadjl1/image/upload/v1608108823/vrsynaaj9uqyxhcbgynx.gif" });
          ...
          data.append('upload_preset', 'wcbta229')
        ...
        onSubmit=(e) => {
            e.preventDefault();
                const userData = {
                    img:this.state.img1,
                    categoryCaterers:this.state.Q25,
                    typeCaterers: this.state.Q26,
                    priceCaterers:this.state.Q27,
                    capacityCaterers:this.state.Q28,
                    costCaterers:this.state.Q29,
...
<input type="file" id="file"   onChange={this.onUpload1} type="file" name="photo" id="upload-photo" />
          ...
          <div className="input" >
              ...
              <input value={ this.state.Q27.ans }    onChange={this.onChange} placeholder="Enter data here"  checked={false}  required ></input>
               </div>
...
<div className="check" >
              ...
              <div className="check" >
<ul>
      <li><input value={this.state.Q30.ans} checked={this.state.op1} onChange={() => this.setState(prevState => ({ Q30: {   ...prevState.Q30, ans: '<100' }  })) }  type="checkbox"></input> {"<"}  1</li>

      <li><input value={this.state.Q30.ans} checked={this.state.op1} onChange={() => this.setState(prevState => ({ Q30: {   ...prevState.Q30, ans: '1-3 years' }  })) }  type="checkbox"></input> 1-3</li>
      <li><input value={this.state.Q30.ans} checked={this.state.op1} onChange={() => this.setState(prevState => ({ Q30: {   ...prevState.Q30, ans: '3.5 years' }  })) }  type="checkbox"></input> 3-5 </li>

<li><input value={this.state.Q30.ans} checked={this.state.op1} onChange={() => this.setState(prevState => ({ Q30: {   ...prevState.Q30, ans: '>5 years' }  })) }  type="checkbox"></input> {">"} 5</li>
